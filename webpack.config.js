...
module.exports = {
	...
	plugins: [
		...buildHTML(['index', 'branch', 'people', 'leaf', 'faq', 'search-result', 'editor', 'authorization-sign-in', 'authorization-approval', 'authorization-recovery', 'authorization-steps', 'leaf-creation']),
